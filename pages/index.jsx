                    ...
                    <div className={style.content}>
                        <div className={style.readme}>
                            ...
                            <div style={{ marginTop: 8, marginLeft: 12, display: 'block' }}>
                                Heyya I'm <strong>Drijon</strong>, born in <strong>South Tyrol</strong> and i currently also live in <strong>South Tyrol</strong> I'm a <strong>Web Developer</strong> and <strong> Server Owner and Team leader</strong>.
                                <br />
                                <br />
